...
def compute_past_series(df, new_cases_col, startday, pastdays_start, pastdays_end, draws, alpha, beta, trend_alpha, lower_ratio, upper_ratio, pickleprefix, 
...
def main(pickleprefix, region, mctargetaccept, pastdays_start, pastdays_end, futuredraws, mctune, mcdraws, tot_chain_len):
    ...
    regions_raw_data = pd.read_csv(
        'https://raw.githubusercontent.com/pcm-dpc/COVID-19/8a4023540242a6f0091b6c3b3aff781d09188392/dati-regioni/dpc-covid19-ita-regioni.csv',
        parse_dates=['data'],
...
if __name__ == "__main__":
    main(sys.argv[1], sys.argv[2], float(sys.argv[3]), *map(int, sys.argv[4:]))
